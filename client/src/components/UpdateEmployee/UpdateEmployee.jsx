...
function UpdateEmployee() {
 ...
 useEffect(() => {
  setEmploye({
      ...
      issued: DetailsEmployee.issued,
      expires: DetailsEmployee.expires,
      test: DetailsEmployee.test,
      test2: DetailsEmployee.test2,
      test3: DetailsEmployee.test3,
      test4: DetailsEmployee.test4,
      certification:DetailsEmployee.certification,
      ctf2: DetailsEmployee.ctf2,
      ctf3: DetailsEmployee.ctf3,
      ctf4: DetailsEmployee.ctf4,
      issuedBy: DetailsEmployee.issuedBy,
      iBy2: DetailsEmployee.iBy2,
      iBy3: DetailsEmployee.iBy3,
      iBy4: DetailsEmployee.iBy4,
      verifiedBy: DetailsEmployee.verifiedBy,
      vrf2: DetailsEmployee.vrf2,
      vrf3: DetailsEmployee.vrf3,
      vrf4: DetailsEmployee.vrf4,
      issuedOn: DetailsEmployee.issuedOn,
      iuOn2: DetailsEmployee.iuOn2,
      iuOn3:DetailsEmployee.iuOn3,
      iuOn4:DetailsEmployee.iuOn4,
    });
